...
module.exports=async(req,res)=>{try{
 ...
 if(req.method==='GET'&&!view){
   ...
   return json(res,200,{profile:p,astrologer:a,followers:Number(a.followers||0),rating:{average:avg,count:reviews.length},todayEarning:earn.reduce((s,x)=>s+Number(x.amount||0),0),connections:conv.length});
 }
