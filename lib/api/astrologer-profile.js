...
module.exports=async(req,res)=>{try{
 ...
 if(req.method==='PATCH'){
  ...
  if('fee' in b) patch.fee=Math.max(0,Number(b.fee)||0);if('fee_per_minute' in b){patch.fee_per_minute=Math.max(0,Number(b.fee_per_minute)||0);patch.fee=patch.fee_per_minute;}
