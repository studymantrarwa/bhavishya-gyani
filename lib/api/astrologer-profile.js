...
module.exports=async(req,res)=>{try{
 ...
 if(req.method==='GET'){
  ...
  if(requestedId && requestedId!==u.id){
   ...
   return json(res,200,{astrologer:{...a,full_name:profileRow?.full_name||'Astrologer',avatar_url:a.avatar_url||profileRow?.avatar_url||null,education:a.education||app[0]?.education||''}});
  }
